...
const reviews = [
    {
        user: "Client A",
        tag: "First Visit",
        content: "강남 달토 처음이었는데 출근 인원이 많아서 선택하기 편했습니다. 하이퍼블릭이 이런 구조구나 이해됐어요. 담당자가 정말 친절하게 케어해줬습니다."
    },
    {
        user: "Client B",
        tag: "Regular",
        content: "예전에 달리는토끼로 알던 곳인데 지금은 달토라고 하더군요. 운영 방식은 그대로라서 익숙했습니다. 가격 장난 없는 게 제일 맘에 듭니다."
    },
    {
        user: "Client C",
        tag: "Solo",
        content: "담당이 계속 붙어서 설명해줘서 편했습니다. 혼자 방문이라 걱정했는데 그 부분이 제일 좋았습니다. 다음에도 이 담당 찾을 예정입니다."
    },
    {
        user: "Client D",
        tag: "Business",
        content: "가격 설명을 먼저 해줘서 마음이 편했어요. 나중에 계산할 때 당황할 일은 없었습니다. 접대 자리였는데 깔끔하게 잘 끝났습니다."
    }
];
  ...
  return (
    <section id="reviews" className="py-32 bg-brand-black">
      <div className="container mx-auto px-6">
        ...
        >
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">REAL VOICE</h2>
